...
function read_all_films() {
    ...
    while ($stmt->fetch()) {
        ...
        $film_html .= "<li>Kestus: " . duration_min_to_hour_and_min($duration_from_db) . "</li> \n";
...
function store_film(
    ...
    $conn->set_charset("utf8");
    /** SQL: INSERT INTO film (pealkiri, aasta, kestus, zanr, tootja, lavastaja)
     * VALUES("Suvi", 1976, 81, "Komöödia", "Tallinnfilm", "Arvo Kruusement")
     */
    $stmt = $conn->prepare(
